...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { active: @follower.active, email: @follower.email, name: @follower.name } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { active: @follower.active, email: @follower.email, name: @follower.name } }
